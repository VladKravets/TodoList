...
import {addTodolistAC, removeTodolistAC, setTodolistsAC} from '../../featuries/Todolist/todolists-reducer';
...
test('tasks should be added for todolists', () => {
    //@ts-ignore
    const action = fetchTasksAC(startState["todolistId1"],"todolistId1");
